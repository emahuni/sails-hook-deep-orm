        ...
        case "inclusive":
            {
                ...
                for (let cri of criterias) {
                    ...
                    let scri =
                        typeOf(nextSubcriteria) === "array"
                            ? nextSubcriteria.shift()
                            : nextSubcriteria;
        ...
        case "polymorphic":
            {
                ...
                if (
                    (all =
                        specificModelsIDs[0] === "" ||
                        criteria === this._WLModel._polymorphicAttribKey ||
                        _.isEmpty(specificModelsIDs))
                ) {
                ...
                for (let modelID of specificModelsIDs) {
                    ...
                    if (
                        (cri = this._WLModel.getPolyAssAliasesToThat(modelID).join(tokens["incl"]))
                    ) {
