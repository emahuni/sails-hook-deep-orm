...
module.exports = function mapPolymorphic(
  models,
  polymorphicModel,
  polyAttribKey,
  polyAttrib
  ...
  const polySeam = sails.config.deeporm.polySeam;
  ...
  _.forIn(models, (model) => {
    ...
    _.forIn(model.attributes, (attrib, attribKey) => {
      ...
      if (
        ...
        ((attrib.hasOwnProperty('model') &&
          attrib.model === polymorphicModelID) ||
        ...
        if (type) {
          ...
          if (attrib.hasOwnProperty('alias')) {
            relation = attrib.alias;
            delete attrib.alias;
          }
          ...
          if (
            models[polymorphicModelID].hasOwnProperty(
              '_polymorphicAssociations'
            )
          ) {
